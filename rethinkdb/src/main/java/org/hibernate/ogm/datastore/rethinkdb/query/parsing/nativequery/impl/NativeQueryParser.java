 ...
 */
@BuildParseTree
public class NativeQueryParser extends BaseParser<RethinkDBQueryDescriptorBuilder> {

	final RethinkDBQueryDescriptorBuilder builder;

	public NativeQueryParser() {
		this.builder = new RethinkDBQueryDescriptorBuilder();
	}
