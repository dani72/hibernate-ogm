 ...
 */
package org.hibernate.ogm.datastore.rethinkdb.logging.impl;
...
public interface Log extends org.hibernate.ogm.util.impl.Log {
    ...
    HibernateException unableToDropDatabase(@Cause Exception e, String databaseName);
    ...
    HibernateException updateQueryMustBeExecutedViaExecuteUpdate(RethinkDBQueryDescriptor queryDescriptor);

    @Message(id = 1228, value = "Query must be executed using 'getResultList()' or 'getSingleResult()' method: %s")
    HibernateException readQueryMustBeExecutedViaGetResultList(RethinkDBQueryDescriptor queryDescriptor);
