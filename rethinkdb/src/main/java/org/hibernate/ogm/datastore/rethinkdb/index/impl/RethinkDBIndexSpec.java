 ...
 */
package org.hibernate.ogm.datastore.rethinkdb.index.impl;
 ...
 */
public class RethinkDBIndexSpec {
	 ...
	 */
	private MapObject indexKeys = com.rethinkdb.RethinkDB.r.hashMap();

	/**
	 * The options specific to MongoDB.
	 */
	private MapObject options;
	 ...
	 */
	public RethinkDBIndexSpec(String collection, String columnName, String indexName, MapObject options) {
	 ...
	 */
	public RethinkDBIndexSpec(UniqueKey uniqueKey, MapObject options) {
	 ...
	 */
	public RethinkDBIndexSpec(Index index, MapObject options) {
	 ...
	 */
	private MapObject prepareOptions(MapObject options, String indexName, boolean unique) {
	...
	public MapObject getIndexKeysDBObject() {
		return indexKeys;
	}
