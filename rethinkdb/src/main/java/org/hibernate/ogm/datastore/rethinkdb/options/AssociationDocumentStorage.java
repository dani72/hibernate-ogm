 ...
 */
package org.hibernate.ogm.datastore.rethinkdb.options;
...
import org.hibernate.ogm.datastore.rethinkdb.options.impl.AssociationDocumentStorageConverter;
...
public @interface AssociationDocumentStorage {
	 ...
	 *
	 * @return the {@link AssociationDocumentStorageType} to use
	 */
	AssociationDocumentStorageType value();
}
