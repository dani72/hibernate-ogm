 ...
 */
package org.hibernate.ogm.datastore.rethinkdb.query.impl;

import com.rethinkdb.model.MapObject;
import static org.hibernate.ogm.datastore.rethinkdb.query.impl.RethinkDBQueryDescriptor.Operation.FINDANDMODIFY;
import static org.hibernate.ogm.datastore.rethinkdb.query.impl.RethinkDBQueryDescriptor.Operation.INSERT;
import static org.hibernate.ogm.datastore.rethinkdb.query.impl.RethinkDBQueryDescriptor.Operation.REMOVE;
import static org.hibernate.ogm.datastore.rethinkdb.query.impl.RethinkDBQueryDescriptor.Operation.UPDATE;
 ...
 */
public class RethinkDBQueryDescriptor implements Serializable {
	...
	private final MapObject criteria;   // Overloaded to be the 'document' for a FINDANDMODIFY query (which is a kind of criteria),
	 ...
	 */
	private final MapObject updateOrInsert;
	 ...
	 * </ul>
	 */
	private final MapObject options;
	private final List<String> unwinds;

	public RethinkDBQueryDescriptor(String collectionName, Operation operation, MapObject criteria, MapObject projection, MapObject orderBy, MapObject options, MapObject updateOrInsert, List<String> unwinds) {
	 ...
	 * INSERT query.
	 */
	public MapObject getUpdateOrInsert() {
