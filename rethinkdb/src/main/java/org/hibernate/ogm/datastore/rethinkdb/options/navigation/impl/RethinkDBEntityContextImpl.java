 ...
 */
public abstract class RethinkDBEntityContextImpl extends BaseDocumentStoreEntityContext<RethinkDBEntityContext, RethinkDBPropertyContext> implements
		RethinkDBEntityContext {

	public RethinkDBEntityContextImpl(ConfigurationContext context) {
		super( context );
	}

	@Override
	public RethinkDBEntityContext associationDocumentStorage(AssociationDocumentStorageType associationDocumentStorage) {
