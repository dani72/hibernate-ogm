 ...
 */
package org.hibernate.ogm.datastore.rethinkdb.test.query.parsing;
...
import org.hibernate.ogm.datastore.rethinkdb.query.parsing.impl.RethinkDBProcessingChain;
import org.hibernate.ogm.datastore.rethinkdb.query.parsing.impl.RethinkDBQueryParsingResult;
import org.hibernate.ogm.datastore.rethinkdb.test.query.parsing.model.IndexedEntity;
import org.hibernate.ogm.datastore.rethinkdb.utils.MapBasedEntityNamesResolver;
import org.hibernate.ogm.utils.OgmTestCase;
import org.junit.Before;
import org.junit.Test;

/**
 * Integration test for {@link org.hibernate.ogm.datastore.rethinkdb.query.parsing.impl.MongoDBQueryResolverDelegate} and
 * {@link org.hibernate.ogm.datastore.rethinkdb.query.parsing.impl.MongoDBQueryRendererDelegate}.
 *
...
public class MongoDBQueryParsingTest extends OgmTestCase {
	...
	public void shouldCreateProjectionQuery() {
		RethinkDBQueryParsingResult parsingResult = parseQuery( "select e.id, e.name, e.position from IndexedEntity e" );
	...
	private void assertMongoDbQuery(String queryString, Map<String, Object> namedParameters, String expectedMongoDbQuery) {
		RethinkDBQueryParsingResult parsingResult = parseQuery( queryString, namedParameters );
	...
	private RethinkDBQueryParsingResult parseQuery(String queryString) {
		return parseQuery( queryString, null );
	}

	private RethinkDBQueryParsingResult parseQuery(String queryString, Map<String, Object> namedParameters) {
	...
	private RethinkDBProcessingChain setUpMongoDbProcessingChain(Map<String, Object> namedParameters) {
		...
		return new RethinkDBProcessingChain( getSessionFactory(), nameResolver, namedParameters );
	}
