 ...
 */
package org.hibernate.ogm.datastore.rethinkdb.test.associations;

import static org.hibernate.ogm.datastore.rethinkdb.utils.RethinkDBTestHelper.assertDbObject;
...
public class MapMappingTest extends OgmTestCase {
	...
	public void testMapOfEntityUsingListStrategyConfiguredViaOptionApi() throws Exception {
		...
		TestHelper.configureOptionsFor( settings, RethinkDB.class )
			.entity( User.class )
