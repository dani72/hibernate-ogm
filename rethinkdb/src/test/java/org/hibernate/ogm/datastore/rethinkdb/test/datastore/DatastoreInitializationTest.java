 ...
 */
package org.hibernate.ogm.datastore.rethinkdb.test.datastore;
...
public class DatastoreInitializationTest {
	...
	public void testAuthentication() throws Exception {
		...
		error.expectCause( hasMessage( containsString( "Connection timed out" ) ) );
...
//	}
//
//	class LeakingMongoDBDatastoreProvider extends RethinkDBDatastoreProvider {
//		public MongoClient leakingClient;
//
//		@Override
//		protected MongoClient createMongoClient(RethinkDBConfiguration config) {
